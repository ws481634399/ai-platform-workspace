# Test Report — STORY-001-03-03-03
...
| TC | AC | DU | 自动化选择器 | 结果 |
|---|---|---|---|---|
| TC-001 | AC-001 | DU-FE-309 | src/auth/clear-session.spec.ts + src/api/http.spec.ts | PASS |
| TC-002 | AC-002 | DU-FE-309 | src/auth/clear-session.spec.ts + src/api/http.spec.ts | PASS |
| TC-003 | AC-003 | DU-FE-309 | src/auth/clear-session.spec.ts + src/api/http.spec.ts | PASS |
