# Test Report — STORY-001-03-03-01
...
| TC | AC | DU | 自动化选择器 | 结果 |
|---|---|---|---|---|
| TC-001 | AC-001 | DU-FE-307 | src/directives/permission.spec.ts | PASS |
| TC-002 | AC-002 | DU-FE-307 | src/directives/permission.spec.ts | PASS |
| TC-003 | AC-003 | DU-FE-307 | src/directives/permission.spec.ts | PASS |
