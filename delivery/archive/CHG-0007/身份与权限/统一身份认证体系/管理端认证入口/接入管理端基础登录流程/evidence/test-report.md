# Test Report — STORY-001-01-04-01
...
| TC | AC | DU | 自动化选择器 | 结果 |
|---|---|---|---|---|
| TC-001 | AC-001 | DU-FE-101 | src/stores/auth.spec.ts | PASS |
| TC-002 | AC-002 | DU-FE-101 | src/stores/auth.spec.ts | PASS |
| TC-003 | AC-003 | DU-FE-101 | src/stores/auth.spec.ts | PASS |
