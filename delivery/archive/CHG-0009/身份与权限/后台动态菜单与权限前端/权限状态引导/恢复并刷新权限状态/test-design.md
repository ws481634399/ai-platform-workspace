...
> Story：STORY-001-03-01-03 — 恢复并刷新权限状态
...
|---|---|---|---|---|
| TC-001 | 组件/E2E 测试 | AC-001 | DU-FE-303 | 验证 刷新浏览器且 Token 有效时，应用重新 bootstrap 并恢复用户、菜单、权限和可访问动态路由。 |
| TC-002 | 组件/E2E 测试 | AC-002 | DU-FE-303 | 验证 相同权限版本重复刷新不会重复注册路由或产生重复菜单。 |
| TC-003 | 组件/E2E 测试 | AC-003 | DU-FE-303 | 验证 权限版本更新并移除一项权限后，对应菜单、按钮和动态路由从前端状态移除。 |
