# Test Report — STORY-001-03-01-01
...
- Delivery Unit：DU-BE-301、DU-FE-301
...
| TC | AC | DU | 自动化选择器 | 结果 |
|---|---|---|---|---|
| TC-001 | AC-001 | DU-BE-301 | M1AcceptanceScenariosTest#administratorBootstrap | PASS |
| TC-002 | AC-002 | DU-FE-301 | src/api/http.spec.ts + src/bootstrap/session.spec.ts | PASS |
| TC-003 | AC-003 | DU-FE-301 | src/api/http.spec.ts + src/bootstrap/session.spec.ts | PASS |
